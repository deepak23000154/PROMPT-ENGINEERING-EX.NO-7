...
## Output:
First, high-priority and time-sensitive tasks: Finish project report (deadline-driven)

Call dentist (appointment windows)

Then, medium-priority: Check emails (flexible timing but necessary)

Finally, flexible tasks: Buy groceries
...
Personalized Assistant: Define the AI's role or personality—like a coach, executive assistant, or productivity expert—and have it respond accordingly.
...
<img width="1164" height="414" alt="image" src="https://github.com/user-attachments/assets/81c1adf3-cc34-44a1-a98d-984c78d5b77b" />
